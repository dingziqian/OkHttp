...
public final class Dispatcher {
  ...
  public synchronized ExecutorService executorService() {
    if (executorService == null) {
      // 核心线程数量，保持在线程池中的线程数量(即使已经空闲)，为0代表线程空闲后不会保留，等待一段时间后停止。
  ...
  // 异步的情况，如果当前请求的数量大于 maxRequests(64) 或者
  // 该call的Host上的call超过maxRequestsPerHost(5) 就放入readyAsyncCalls
  // 否则放入 runningAsyncCalls 并执行该call
